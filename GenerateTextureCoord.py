...
filename = ["listerin_.stl", "glue_.stl", "pen_.stl", "s5_.stl", "gear_.stl"]
texturefile = ["listerin.png", "glue.png", "pen.png", "s5.png", "gear.png"]
...
#bmpReader.SetFileName(VTK_DATA_ROOT + "a.bmp")
#bmpReader.SetFileName("a.bmp")

bmpReader = vtk.vtkPNGReader()
bmpReader.SetFileName(texturefile[0])
